...
def main() -> int:
    parser = argparse.ArgumentParser(description="Normalize deepSURF-style raw outputs for RustDPR")
    ...
    meta = {
        ...
        "notes": "LLM-generated harness case study; not full deepSURF reproduction",
        "extra": {"llm_model": args.llm_model, "prompt_id": args.prompt_id},
    }
