...
def main() -> int:
    parser = argparse.ArgumentParser(description="Normalize RPG raw outputs for RustDPR")
    ...
    meta = {
        ...
        "notes": "RPG generated harness normalized for RustDPR validation",
    }
