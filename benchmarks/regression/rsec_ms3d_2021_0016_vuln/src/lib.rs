//! Regression reproducer for RUSTSEC-2021-0016 / ms3d.
//!
//! This benchmark invokes the real `ms3d` public API `Model::from_reader`.
//! The historical vulnerable implementation passed an uninitialized internal
//! buffer to a user-provided `Read` implementation. The custom reader below is
//! fully safe Rust and deliberately observes the first byte of the buffer before
//! writing to it, matching the RustSec advisory trigger.
...
pub const FN_MS3D_MODEL_FROM_READER: &str = "crate::run_public_api_poc";
...
/// Real public-API PoC for RUSTSEC-2021-0016.
